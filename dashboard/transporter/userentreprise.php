		   ...
		   function displayImage(e) {
			 if (e.files[0]) {
			   ...
			   reader.readAsDataURL(e.files[0]);
                    ...
                    <h5 class="title" style="color:#212529;">Opticharge</h5>
                    <p class="text-center"style="color:#9EA0A5;"> Mohammadia, Alger</p>
                  </a>
                ...
                <form>
                  ...
                  <div class="col-md-10 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Nom De L'entreprise" value="">
                      </div>
                    </div>
                   </div>
                  <div class="row">
                ...
                <div class="row" style="padding-top:3vmin;">
                    <div class="col-md-4 offset-md-1">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Numéro de registre de commerce" value="">
                     </div>
...
<form id="file-upload-form" action="">
	...
	<output for="file-upload" id="messages"></output>
                 ...
                 Félicitation. Votre entreprise est un transporteur vérifié.
               </span>
      </div>
          </div>
              </div>
